...
# Не видит папки за рамками задания, приходится подключать корень проекта, можно через докер, но пока что не здесь. ГЫ
...
def main() -> None:
    ...
    python TASKS/task_4/cli_main.py --students "resources/json/students.json" --rooms "resources/json/rooms.json" --format json
    python TASKS/task_4/cli_main.py --students "resources/json/students.json" --rooms "resources/json/rooms.json" --format xml
    """
